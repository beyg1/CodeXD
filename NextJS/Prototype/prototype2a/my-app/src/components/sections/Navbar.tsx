...
const CylindricalNavbar: React.FC = () => {
  return (
    <nav className="fixed top-4 left-4 right-4 z-50 p-4 flex justify-between items-center w-auto rounded-full bg-gradient-to-r from-white/10 to-white/30 backdrop-blur-md backdrop-filter border border-white/40 shadow-lg">
