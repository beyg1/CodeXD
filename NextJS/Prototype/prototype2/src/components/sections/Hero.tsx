...
<span className="block py-2 sm:text-5xl md:text-7xl text-[#4237d9] text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-violet-500 animate-gradient animate-jump-in animate-once animate-ease-out">
                Agentia World
              </span>
            </div>
            <span className="text-white py-3 sm:py-5 font-semibold sm:text-3xl md:text-4xl mt-4 animate-pulse animate-once animate-ease-linear">
            Revolutionize Your Business with On-Demand AI Agents
            </span>
          </h1>
<p className="mx-auto mt-3 text-ellipsis max-w-md text-sm sm:text-lg  md:max-w-3xl md:text-xl px-4 animate-jump-in animate-once animate-ease-in-out">
