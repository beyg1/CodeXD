  ...
  return (
    <section className="relative w-full min-h-screen bg-neutral-800">
      ...
      <div className="flex flex-col md:flex-row h-screen">
        ...
        <div className="flex bg-black flex-col w-full md:w-1/2 md:absolute md:bottom-0 md:left-0 md:mt-auto md:ml-auto md:mb-auto md:mr-8 order-1">
        ...
        <div className="w-full flex flex-col md:w-1/2 h-screen bg-white order-2">
          <AnimatedBeamDemo />
        </div>
      </div>
    </section>
