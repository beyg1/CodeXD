    ...
    <section className="relative w-full min-h-screen bg-neutral-800">
      ...
      <div className="relative z-10 flex min-h-screen px-4 py-8">
        <div className="container mx-auto flex flex-col md:flex-row-reverse items-center justify-between gap-8">
          {/* Lottie Animation */}
          <div className="w-full md:w-1/2 flex justify-center items-center md:absolute md:top-0 md:right-0">
          <Lottie />
          </div>
          {/* Text Content */}
          <div className="flex flex-col w-full md:w-1/2 md:absolute md:bottom-0 md:left-0 md:mt-auto md:ml-auto md:mb-auto md:mr-8 md:mb-8">
