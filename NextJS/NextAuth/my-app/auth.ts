...
import { formSchema } from "@/app/auth/login/page"  // Make sure this import matches your form schema location
...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  pages: {
    signIn: '/auth/login',  // Make sure this matches your actual route
  },
})
